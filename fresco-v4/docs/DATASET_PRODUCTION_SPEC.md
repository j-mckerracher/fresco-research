...
| Artifact | Path |
|----------|------|
| Dataset root | `<FRESCO_DATA_ROOT>/chunks-v3/` |
| Output manifest | `<FRESCO_DATA_ROOT>/chunks-v3/manifests/output_manifest.jsonl` |
| Run metadata | `<FRESCO_DATA_ROOT>/chunks-v3/manifests/run_metadata.json` |
| Validation artifacts | `<FRESCO_DATA_ROOT>/chunks-v3/validation/` |
